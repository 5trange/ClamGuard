...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.title_label.setStyleSheet("color: #81a1c1;")
        ...
        self.mainInterface.setStyleSheet("background-color:none;")
        ...
        self.scanImg.setStyleSheet(
            "QLabel\n{\n	color: rgb(0, 255, 38);\n	border:none;\n}\n"
        )
        self.scanImg.setPixmap(QPixmap("img/search.png"))
        ...
        self.updateFrame.setStyleSheet(
            "QFrame\n"
            "{\n"
            "	border: 5px solid #81a1c1;\n"
            "	border-radius: 80px;\n"
        ...
        self.updateImg.setObjectName("updateImg")
        ...
        self.updateImg.setStyleSheet(
            "QLabel\n{\n	color: rgb(0, 255, 38);\n	border:none;\n}\n"
        )
        self.updateImg.setPixmap(QPixmap("img/update.png"))
        ...
        self.aboutLabel.setPixmap(QPixmap("img/info.png"))
        ...
        self.quarantineLabel.setStyleSheet(
            "QLabel\n"
            "{\n"
            "	color:rgb(0, 182, 24);\n"
            "	border:none;\n"
        ...
        self.quarantineLabel.setPixmap(QPixmap("img/warning.png"))
        self.quarantineLabel.setScaledContents(True)
        self.voyagerHome = QLabel(self.frame_content_home)
        self.voyagerHome.setObjectName("voyagerHome")
        self.voyagerHome.setGeometry(QRect(0, 0, 801, 551))
        self.voyagerHome.setPixmap(QPixmap("img/voyager.png"))
        ...
        self.pageScan.setObjectName("pageScan")
        ...
        icon = QIcon()
        icon.addFile("img/home.png", QSize(), QIcon.Normal, QIcon.Off)
        self.homeButton.setIcon(icon)
        self.homeButton.setIconSize(QSize(50, 50))
        self.moonG = QLabel(self.frameHome)
        self.moonG.setObjectName("moonG")
        self.moonG.setGeometry(QRect(630, 0, 191, 171))
        self.moonG.setPixmap(QPixmap("img/pixelmoon.png"))
        ...
        self.frameScanButtons.setObjectName("frameScanButtons")
        ...
        self.customscanButton.setObjectName("customscanButton")
        ...
        self.customscanButton.setStyleSheet(
            "QPushButton\n"
            "{\n"
            "	border: 1px solid #b48ead;\n"
            "	border-radius: 5px;\n"
        ...
        self.cancelscanButton.setStyleSheet(
            "QPushButton\n"
            "{\n"
            "	border: 1px solid #b48ead;\n"
            "	border-radius: 5px;\n"
        ...
        self.frameScanStatus.setObjectName("frameScanStatus")
        ...
        self.scanStatus.setObjectName("scanStatus")
        self.scanStatus.setFont(font)
        self.scanStatus.setStyleSheet(
            "QPlainTextEdit\n"
            "{\n"
            "	 \n"
            "	background-color: #2e3440;\n"
        ...
        self.frameGoHome.setObjectName("frameGoHome")
        ...
        self.moonG2.setObjectName("moonG2")
        self.moonG2.setGeometry(QRect(630, 0, 191, 171))
        self.moonG2.setPixmap(QPixmap("img/pixelmoon.png"))
        ...
        self.frameUpdateButtons.setObjectName("frameUpdateButtons")
        ...
        self.checkUpdate.setStyleSheet(
            "QPushButton\n"
            "{\n"
            "	border: 1px solid #b48ead;\n"
            "	border-radius: 5px;\n"
        ...
        self.cancelUpdate.setObjectName("cancelUpdate")
        ...
        self.cancelUpdate.setStyleSheet(
            "QPushButton\n"
            "{\n"
            "	border: 1px solid #b48ead;\n"
            "	border-radius: 5px;\n"
        ...
        self.frameUpdateStatus.setObjectName("frameUpdateStatus")
        ...
        self.updateStatus.setObjectName("updateStatus")
        ...
        self.updateStatus.setStyleSheet(
            "QPlainTextEdit\n"
            "{\n"
            "	 \n"
            "	background-color: #2e3440;\n"
        ...
        self.frameHomeAbout.setObjectName("frameHomeAbout")
        ...
        self.homeButtonAbout.setObjectName("homeButtonAbout")
        ...
        self.homeButtonAbout.setStyleSheet(
            "QPushButton\n"
            "{\n"
            "	border: 1px solid #b48ead;\n"
            "	border-radius: 5px;\n"
        ...
        self.moonG3.setObjectName("moonG3")
        self.moonG3.setGeometry(QRect(630, 0, 191, 171))
        self.moonG3.setPixmap(QPixmap("img/pixelmoon.png"))
        ...
        self.frameAboutContent.setObjectName("frameAboutContent")
        ...
        self.quarantineHomeButton.setObjectName("quarantineHomeButton")
        ...
        self.quarantineHomeButton.setStyleSheet(
            "QPushButton\n"
            "{\n"
            "	border: 1px solid #b48ead;\n"
            "	border-radius: 5px;\n"
        ...
        self.moonG4.setObjectName("moonG4")
        self.moonG4.setGeometry(QRect(630, 0, 191, 171))
        self.moonG4.setPixmap(QPixmap("img/pixelmoon.png"))
        ...
        self.frameQuarantineContent.setObjectName("frameQuarantineContent")
        ...
        self.quarantineRefresh.setObjectName("quarantineRefresh")
        ...
        self.quarantineRefresh.setStyleSheet(
            "QPushButton\n"
            "{\n"
            "	border: 1px solid #b48ead;\n"
            "	border-radius: 5px;\n"
        ...
        self.quarantineView.setObjectName("quarantineView")
        self.quarantineView.setGeometry(QRect(9, 45, 745, 275))
        self.quarantineView.setStyleSheet(
            "QTableWidget\n"
            "{ \n"
            "	background-color: #2e3440;\n"
            "	color: #d8dee9;\n"
        ...
        self.engineVer.setObjectName("engineVer")
        font7 = QFont()
        font7.setPointSize(7)
        font7.setBold(True)
        self.engineVer.setFont(font7)
        self.engineVer.setStyleSheet("color: #81a1c1;")
    ...
    def retranslateUi(self, mainWindow):
        mainWindow.setWindowTitle(
            QCoreApplication.translate("mainWindow", "ClamGuard", None)
        )
        self.title_label.setText(
            QCoreApplication.translate("mainWindow", "ClamGuard Security", None)
        )
        ...
        self.scanlabel.setText(QCoreApplication.translate("mainWindow", "SCAN", None))
        ...
        # if QT_CONFIG(tooltip)
        self.aboutLabel.setToolTip(
            QCoreApplication.translate("mainWindow", "About ClamGuard Project", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.aboutLabel.setText("")
        # if QT_CONFIG(tooltip)
        self.quarantineLabel.setToolTip(
            QCoreApplication.translate("mainWindow", "View Quarantine", None)
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(tooltip)
        self.quickscanButton.setText(
            QCoreApplication.translate("mainWindow", "Quick Scan", None)
        )
        # if QT_CONFIG(tooltip)
        self.fullscanButton.setToolTip("")
        # endif // QT_CONFIG(tooltip)
        self.fullscanButton.setText(
            QCoreApplication.translate("mainWindow", "Full Scan", None)
        )
        # if QT_CONFIG(tooltip)
        self.customscanButton.setToolTip("")
        # endif // QT_CONFIG(tooltip)
        self.customscanButton.setText(
            QCoreApplication.translate("mainWindow", "Custom Scan", None)
        )
        self.cancelscanButton.setText(
            QCoreApplication.translate("mainWindow", "Cancel Scan", None)
        )
        ...
        self.cancelUpdate.setText(
            QCoreApplication.translate("mainWindow", "Cancel Update", None)
        )
        self.homeButtonAbout.setText("")
        self.moonG3.setText("")
        self.ProjectTitle.setText(
            QCoreApplication.translate("mainWindow", "ClamGuard Project", None)
        )
        self.AboutGithub.setText("")
        self.AboutGPL.setText("")
        self.label.setText(
            QCoreApplication.translate(
                "mainWindow", "An opensource antivirus solution based on ClamAV.", None
            )
        )
        ...
        self.label_3.setText(
            QCoreApplication.translate(
                "mainWindow",
                "Developed using PySide6 and Python3. The full source code is available in our GitHub repository.",
                None,
            )
        )
        self.quarantineHomeButton.setText("")
        self.moonG4.setText("")
        self.quarantineRefresh.setText(
        ...
        self.engineVer.setText(
            QCoreApplication.translate(
                "mainWindow", "ClamGuard Version: 0.7.7-rc", None
            )
        )
